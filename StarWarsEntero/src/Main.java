...
public class Main {
    ...
    //Variables bandera para el bucle que hace funcionar todo el juego.
    ...
    private static void inicializarTableroCopia(char[][] tablero) {
        for (int i = 0; i < MAX_FILAS; i++) {
            for (int j = 0; j < MAX_COLUMNAS; j++) {
                tablero[i][j] = '0';
            }
    ...
    //4º) Una función que nos pueda mostrar cada matriz 10x10 presente en el juego.
    ...
    private static void iniciarTodo() {
        ...
        inicializarTableroCopia(tableroYodaCopia);
        inicializarTableroCopia(tableroVaderCopia);
...
//------------------------------------------Turno Yoda----------------------------------------------------------------
            ...
            if (pocimaActivaYoda) {
                ...
                cantidadYoda = Integer.parseInt(direccionYoda.substring(0, 1));
                teclaYoda = direccionYoda.charAt(1);
...
//---------------------------------------Turno Vader----------------------------------------------------------------
            ...
            if (pocimaActivaVader) {
                ...
                cantidadVader = Integer.parseInt(direccionVader.substring(0, 1));
                teclaVader = direccionVader.charAt(1);
